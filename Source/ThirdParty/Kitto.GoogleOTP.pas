{###############################################################################
                   ...
                   Version changed with Kitto Prefix for KittoX
###############################################################################}
unit Kitto.GoogleOTP;
...
begin
  Result := '';
  ValCharLen := Length(Kitto.Base32U.ValidChars);
  ...
  for i := 1 to len do
  begin
    Result := Result + copy(Kitto.Base32U.ValidChars, Random(ValCharLen) + 1, 1);
  end;
end;
